...
public class UserController {
	...
	public String register(User user,String oldUrl,HttpServletRequest request)throws Exception{
		Integer result=userService.add(user);//往数据库里面添加注册信息
		if(result<=0){
			request.setAttribute("user", user);
