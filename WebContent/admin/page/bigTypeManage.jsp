...
function openBigTypeAddDialog(){
	$("#dlg").dialog("open").dialog("setTitle","添加中药材大类");
...
function searchBigType(){
	/*当点击搜索按钮时，会触发 datagrid.load方法。把参数bigTypeName传入到后台，
	通过requet.getParamete(‘bigTypeName’)获取到，从而实现搜索功能*/
	$("#dg").datagrid("load",{
...
<body>
	<table id="dg" title="中药材大类管理" class="easyui-datagrid"
	...
	<div id="tb">
		...
		<div>
			&nbsp;中药材大类名称：&nbsp;<input type="text" id="s_bigTypeName" size="20" onkeydown="if(event.keyCode==13) searchBigType()"/>
