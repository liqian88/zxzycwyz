...
function openSmallTypeAddDialog(){
	$("#dlg").dialog("open").dialog("setTitle","添加中药材小类");
...
<body>
	<table id="dg" title="中药材小类管理" class="easyui-datagrid"
	...
	<div id="tb">
		...
		<div>
			&nbsp;中药材小类名称：&nbsp;<input type="text" id="s_smallTypeName" size="20" onkeydown="if(event.keyCode==13) searchSmallType()"/>
