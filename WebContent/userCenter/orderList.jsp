...
<div class="panel panel-default">
  ...
  <table class="list table-bordered">
	<c:forEach var="order" items="${orderList }">
		...
		<c:forEach var="orderZyc" items="${order.orderZycList }">
			<tr>
				<td width="50%">
					<a href="${pageContext.request.contextPath}/zyc/${orderZyc.zyc.id}.html" target="_blank"><img width="72" height="72" src="${pageContext.request.contextPath}/${orderZyc.zyc.pic }"></a>
					&nbsp;&nbsp;
					<a href="${pageContext.request.contextPath}/zyc/${orderZyc.zyc.id}.html" target="_blank">${orderZyc.zyc.name}</a>
				</td>
				<td width="17%">
					&nbsp;&nbsp;
					${orderZyc.zyc.price}
				...
				<td>
					&nbsp;&nbsp;小计：
					${orderZyc.num*orderZyc.zyc.price}&nbsp;(元)
				</td>
			</tr>
		</c:forEach>
	</c:forEach>
